...
/// @notice Manually maintained native/USD reference for Robinhood testnet only.
/// @dev ProtoFactory snapshots this value at launch. Trading never reads it.
contract TestnetLaunchPriceOracle is ILaunchPriceOracle {
    ...
    event PriceUpdated(uint256 priceUsd8, uint256 updatedAt);
